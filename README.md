# FPL Student Attendance System - SFaceTrack
...
The application is deployed using Docker Compose with separate configurations for development and production environments:
