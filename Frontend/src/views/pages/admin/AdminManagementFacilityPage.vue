<template>
  ...
  <!-- Danh sách cơ sở -->
  <a-card title="Danh sách cơ sở" :bordered="false" class="cart">
    <!-- Nút thêm cơ sở -->
    ...
    >
      ...
      <template #bodyCell="{ column, record }">
        <!-- Hiển thị trạng thái theo facilityStatus -->
        <template v-if="column.dataIndex === 'facilityStatus'">
          <a-tag
            :color="
              record.facilityStatus === 'ACTIVE' || record.facilityStatus === 1 ? 'green' : 'red'
            "
          >
            {{
...
const columns = ref([
  { title: 'STT', dataIndex: 'facilityIndex', key: 'facilityIndex' },
  { title: 'Tên cơ sở', dataIndex: 'facilityName', key: 'facilityName' },
  { title: 'Mã cơ sở', dataIndex: 'facilityCode', key: 'facilityCode' },
  { title: 'Trạng thái', dataIndex: 'facilityStatus', key: 'facilityStatus' },
