...
import udpm.hn.studentattendance.core.staff.student.service.impl.STStudentServiceImpl;
...
public class EXStudentServiceImplTest {
    @Mock
    private STStudentServiceImpl stStudentService;
    @Mock
    ...
    void testGetDataFromFile_EmptyFile() {
        ...
        var response = exStudentService.getDataFromFile(request);
