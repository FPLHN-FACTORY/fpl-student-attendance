...
import udpm.hn.studentattendance.core.staff.factory.service.impl.USFactoryServiceImpl;
...
public class EXFactoryServiceImplTest {
    @Mock
    private USFactoryServiceImpl usFactoryService;
    @Mock
    ...
    void testGetDataFromFile_EmptyFile() {
        ...
        var response = exFactoryService.getDataFromFile(request);
