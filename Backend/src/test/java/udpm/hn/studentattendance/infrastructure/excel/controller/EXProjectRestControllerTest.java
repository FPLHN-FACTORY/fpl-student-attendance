...
class EXProjectRestControllerTest {
    @Mock
    private EXProjectService service;

    @InjectMocks
    private EXProjectRestController controller;
    ...
    void testExportData() {
        ...
        when(service.exportData(request)).thenReturn((ResponseEntity) ResponseEntity.ok("exported"));
