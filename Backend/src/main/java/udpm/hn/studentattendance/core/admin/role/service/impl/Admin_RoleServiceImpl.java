...
import udpm.hn.studentattendance.core.admin.role.repository.Admin_RoleFacilityRepository;
import udpm.hn.studentattendance.core.admin.role.repository.Admin_RoleRepository;
import udpm.hn.studentattendance.core.admin.role.repository.Admin_RoleStaffRepository;
...
public class Admin_RoleServiceImpl implements Admin_RoleService {
    ...
    private final Admin_RoleRepository adRoleRepository;

    private final Admin_RoleFacilityRepository adRoleFacilityRepository;

    private final Admin_RoleStaffRepository adRoleStaffRepository;
