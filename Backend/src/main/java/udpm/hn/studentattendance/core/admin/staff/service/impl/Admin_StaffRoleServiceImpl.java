...
@Validated
public class Admin_StaffRoleServiceImpl implements Admin_StaffRoleService {

    private final Admin_StaffRoleRepository adStaffRoleRepository;

    private final Admin_StaffRepository adStaffRepository;

    private final Admin_StaffFacilityRepository adStaffFacilityRepository;

    private final Admin_StaffAdminRepository adStaffAdminRepository;

    @Override
    public ResponseEntity<?> getAllRole(String staffId) {
        List<Admin_StaffRoleResponse> list = adStaffRoleRepository.getRolesByStaffId(staffId, EntityStatus.ACTIVE, EntityStatus.ACTIVE);
        if (list.size() <= 0) {
    ...
    @Override
    public ResponseEntity<?> getRoleChecked(Admin_StaffRoleRequest adStaffRoleRequest) {
    ...
    @Override
    public ResponseEntity<?> changeStaffRole(Admin_ChangeStaffRoleRequest request) {
