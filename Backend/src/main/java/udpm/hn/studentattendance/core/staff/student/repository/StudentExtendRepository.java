...
@Repository
public interface StudentExtendRepository extends UserStudentRepository {
    @Query(
            value = """
                    SELECT
    ...
    Page<StudentResponse> getAllStudentByFacility(Pageable pageable, StudentRequest studentRequest, String facilityId);
