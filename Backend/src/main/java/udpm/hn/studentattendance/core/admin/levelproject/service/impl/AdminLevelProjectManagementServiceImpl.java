...
import udpm.hn.studentattendance.core.admin.levelproject.repository.AdminLevelProjectRepository;
...
@Service
public class AdminLevelProjectManagementServiceImpl implements AdminLevelProjectManagementService {

    @Autowired
    private AdminLevelProjectRepository repository;

    @Override
    public ResponseObject<?> getListLevelProject(AdminLevelProjectSearchRequest request) {
