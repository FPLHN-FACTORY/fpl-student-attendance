package udpm.hn.studentattendance.core.staff.factory.repository.user_student_factory;
...
import udpm.hn.studentattendance.core.staff.factory.model.response.student_factory.Staff_StudentFactoryResponse;
    ...
    @Query(value = """
            ...
            """, countQuery = """
                ...
                WHERE 
                    ...
                    AND us.id = :userStudentId
            """, nativeQuery = true)
    Page<Staff_PDDetailShiftByStudentResponse> getAllPlanDateByStudent(Pageable pageable, Staff_PDDetailShiftByStudentRequest request, String userStudentId);
}
