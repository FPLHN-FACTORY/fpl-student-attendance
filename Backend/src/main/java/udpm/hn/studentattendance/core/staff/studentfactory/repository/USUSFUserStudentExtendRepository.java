    ...
    @Query(value = """
            ...
            WHERE f.id = :facilityId
              ...
              AND (
                  ...
                  OR us.id LIKE CONCAT('%', TRIM(:#{#userStudentRequest.searchQuery}), '%')
                  OR us.code LIKE CONCAT('%', TRIM(:#{#userStudentRequest.searchQuery}), '%')
                  OR us.name LIKE CONCAT('%', TRIM(:#{#userStudentRequest.searchQuery}), '%')
                  OR us.email LIKE CONCAT('%', TRIM(:#{#userStudentRequest.searchQuery}), '%')
              )
