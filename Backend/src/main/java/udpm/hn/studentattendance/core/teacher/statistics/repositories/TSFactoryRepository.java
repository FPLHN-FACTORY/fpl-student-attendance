...
@Repository
public interface TSFactoryRepository extends FactoryRepository {
    ...
    @Query(value = """
                ...
                WHERE
                    s.status = 1 AND
                    f.id_user_staff = :#{#request.idUserStaff} AND
            ...
            """, countQuery = """
                ...
                WHERE
                    ...
                    sf.id_facility = :#{#request.idFacility}
            """, nativeQuery = true)
    Page<TSFactoryStatsResponse> getAllByFilter(Pageable pageable, TSFilterFactoryStatsRequest request);
    ...
    @Query(value = """
                ...
                ORDER BY f.name ASC
    """, nativeQuery = true)
    List<Factory> getAllFactoryBySemester(String idSemester, String idFacility, String idUserStaff);
    ...
    """, nativeQuery = true)
    List<TSPlanDateStudentFactoryResponse> getAllPlanDateAttendanceByIdFactory(String idFactory, Long startDate, Long endDate);
