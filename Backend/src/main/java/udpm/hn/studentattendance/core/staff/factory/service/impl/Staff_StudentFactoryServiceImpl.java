...
import udpm.hn.studentattendance.core.staff.factory.model.response.student_factory.Staff_DetailUserStudentFactory;
import udpm.hn.studentattendance.core.staff.factory.model.response.student_factory.Staff_PDDetailShiftByStudentResponse;
import udpm.hn.studentattendance.core.staff.factory.model.response.student_factory.Staff_UserStudentResponse;
import udpm.hn.studentattendance.core.staff.factory.repository.factory.Staff_FactoryExtendRepository;
import udpm.hn.studentattendance.core.staff.factory.repository.user_student_factory.Staff_StudentFactoryRepository;
import udpm.hn.studentattendance.core.staff.factory.repository.user_student_factory.Staff_USFUserStudentExtendRepository;
...
public class Staff_StudentFactoryServiceImpl implements Staff_StudentFactoryService {
    ...
    private final Staff_USFUserStudentExtendRepository userStudentFactoryExtendRepository;
    ...
    public ResponseEntity<?> detailStudentFactory(String userStudentId) {
        Optional<Staff_DetailUserStudentFactory> detailUserStudentFactory = studentFactoryRepository.getDetailUserStudent(userStudentId);
        return new ResponseEntity<>(
                new ApiResponse(
                        RestApiStatus.SUCCESS,
                        "Lấy thành công sinh viên",
                        detailUserStudentFactory),
                HttpStatus.OK);
    }

    @Override
    public ResponseEntity<?> getAllPlanDateByStudent(Staff_PDDetailShiftByStudentRequest request, String userStudentId) {
        Pageable pageable = PaginationHelper.createPageable(request);
        PageableObject<Staff_PDDetailShiftByStudentResponse> data = PageableObject.of(studentFactoryRepository.getAllPlanDateByStudent(pageable, request, userStudentId));
