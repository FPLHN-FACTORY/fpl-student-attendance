...
@Repository
public interface USSubjectFacilityFactoryExtendRepository extends SubjectFacilityRepository {
        @Query("""
                                SELECT
                                sf
                                FROM
                                ...
                                f.id = :facilityId
                        """)
        List<SubjectFacility> getAllSubjectFacility(EntityStatus subjectFacilityStatus, EntityStatus facilityStatus,
                        String facilityId);
}
