package udpm.hn.studentattendance.core.admin.adminsubjectfacilitymanagement.repository;
...
import udpm.hn.studentattendance.core.admin.adminsubjectfacilitymanagement.model.response.AdminSubjectFacilityResponse;
import udpm.hn.studentattendance.repositories.SubjectFacilityRepository;

import java.util.List;

@Repository
public interface AdminSubjectFacilityRepository extends SubjectFacilityRepository {
    ...
    @Query(value = """
            ...
            """, countQuery = """
                    ...
                    AND (:#{#request.status} IS NULL OR sf.status = :#{#request.status})
            """, nativeQuery = true)
    Page<AdminSubjectFacilityResponse> getAll(Pageable pageable, @Param("request") AdminSubjectFacilitySearchRequest request);
