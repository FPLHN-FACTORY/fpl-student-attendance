...
import udpm.hn.studentattendance.core.staff.student.model.response.StudentResponse;
import udpm.hn.studentattendance.core.staff.student.repository.StudentExtendRepository;
...
public class StudentServiceImpl implements StudentService {
    ...
    @Override
    public ResponseEntity<?> getAllStudentByFacility(StudentRequest studentRequest) {
    ...
    @Override
    public ResponseEntity<?> createStudent(StudentCreateUpdateRequest studentCreateUpdateRequest) {
    ...
    @Override
    public ResponseEntity<?> updateStudent(StudentCreateUpdateRequest studentCreateUpdateRequest) {
