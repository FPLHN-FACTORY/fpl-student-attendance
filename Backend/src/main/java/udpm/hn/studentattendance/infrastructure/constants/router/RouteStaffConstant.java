...
import static udpm.hn.studentattendance.infrastructure.constants.RoutesConstant.PREFIX_API_STAFF_MANAGEMENT;
...
public final class RouteStaffConstant {
    ...
    public static final String URL_API_STUDENT_FACTORY_MANAGEMENT = PREFIX_API_STAFF_MANAGEMENT + "/factory-management/student";

    public static final String URL_API_STUDENT_MANAGEMENT = PREFIX_API_STAFF_MANAGEMENT + "/student-management";

    public static final String URL_API_PLAN_DATE_MANAGEMENT = PREFIX_API_STAFF_MANAGEMENT + "/plan-date-management";

    public static final String URL_API_PLAN_DATE_ATTENDANCE_MANAGEMENT = PREFIX_API_STAFF_MANAGEMENT + "/plan-date-attendance-management";
