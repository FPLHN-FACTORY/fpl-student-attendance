...
public final class RouteTeacherConstant {
    ...
    public static final String URL_API_SHIFT_FACTORY_MANAGEMENT = PREFIX_API_TEACHER_MANAGEMENT + "/factory-management/shift";

    public static final String URL_API_PLANDATE_ATTENDANCE_FACTORY_MANAGEMENT = PREFIX_API_TEACHER_MANAGEMENT + "/factory-management/attendance";
