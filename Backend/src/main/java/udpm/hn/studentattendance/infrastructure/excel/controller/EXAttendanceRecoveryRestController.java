...
@RequestMapping(RouteExcelConstant.URL_API_ATTENDANCE_RECOVERY)
public class EXAttendanceRecoveryRestController implements IEXDefaultController {

    private final EXAttendanceRecoveryService service;
